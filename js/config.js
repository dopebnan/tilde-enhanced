const CONFIG = {
  ...
  commands: [{
    ...
    },
    {
      ...
      search: '/search?q={}',
      color: 'linear-gradient(135deg, #fe640b, #df8e1d)',
      icon: 'stackoverflow',
      quickLaunch: true,
    },
    {
    ...
    color: 'linear-gradient(135deg, #1e66f5, #209fb5)',
    icon: 'mdn',
    quickLaunch: false,
    },

    {
      ...
      color: 'linear-gradient(135deg, #d20f39, #e64553)',
      icon: 'youtube',
      quickLaunch: false,
    },
    {
      ...
      search: '/search?q={}',
      color: 'linear-gradient(135deg, #fe640b, #e64553)',
      icon: 'reddit',
      quickLaunch: false,
    },
    {
...

    {
      ...
      color: 'linear-gradient(135deg, #209fb5, #04a5e5)',
      icon: 'twitter',
      quickLaunch: true,
    },
    {
